...
const requirements: Requirement[] = [
  ...
  { section: "aiVoice", path: "aiVoice.receptionistName", label: "Receptionist name" },
  { section: "aiVoice", path: "aiVoice.agentDisplayName", label: "ElevenLabs agent display name" },
  ...
  { section: "aiVoice", path: "aiVoice.systemPrompt", label: "Agent system prompt" },
